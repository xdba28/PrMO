...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2018 at 10:23 AM
...
INSERT INTO `account_requests` (`ID`, `fname`, `midle_name`, `last_name`, `ext_name`, `employee_id`, `email`, `designation`, `username`, `userpassword`) VALUES
(1, 'Paula Jane', 'Balatucan', 'Socito', '', '2015-9999', 'paulajane.socito@bicol-u.edu.ph', 1, 'pjane101', 'pjane101@');
...
CREATE TABLE IF NOT EXISTS `enduser` (
  ...
  `edr_designated_office` varchar(50) NOT NULL,
...
('2000-12345', 'Christian', 'Y', 'Sy', 'XXXXX', 'christian.sy@bicol-u.edu.ph', '', '', NULL),
('2015-11583', 'Denver', 'B', 'Arancillo', 'XXXXX', 'denver.arancillo@bicol-u.edu.ph', 'BAC - PrMO', 'none', NULL),
('2015-15096', 'Nico', 'Villaraza', 'Ativo', 'XXXXX', 'nico.ativo@bicol-u.edu.ph', 'CS-Faculty', 'Gangster', NULL);
...
CREATE TABLE IF NOT EXISTS `personnel` (
  ...
  `prnl_designated_office` varchar(50) NOT NULL,
...
('2014-001-171', 'Jane', 'Arcinue', 'Millamina', 'XXXXX', 'janemillamina18@gmail.com', 'PrMO', 'JO', 'sample', NULL),
('2015-42911', 'Ma. Julieta', 'Madla', 'Borres', 'XXXXX', 'sample.email@gmail.com', 'BAC-PrMO', 'Director', 'sample', NULL);
...
(2, '2015-15096', 'f24aecf50e5d68bbac649076e1fab375134ffffe592174c64fb2aa480276b2d8');
...
--
ALTER TABLE `enduser`
  ADD PRIMARY KEY (`edr_id`), ADD UNIQUE KEY `edr_email` (`edr_email`), ADD KEY `edr_id` (`edr_id`);
...
ALTER TABLE `personnel`
  ADD PRIMARY KEY (`prnl_id`), ADD UNIQUE KEY `prnl_email` (`prnl_email`), ADD KEY `prnl_id` (`prnl_id`);

			...
			if(rItems.length !== 0){
				...
				rItems.each(function(i, e){
					...
					switch(rDetails[0]){  
						case "PR":
							if(!prT_header){
								$('#pr-content').html(`<table class="table table-bordered table-hover"><thead><tr>
								...
								</tr></thead><tbody id="pr-detail"></tbody></table><br>`);
								prT_header = true;
							}
						...
						case "JO":
							...
							$('#jo-content').append(`<table class="table table-bordered table-hover"><thead><tr>
								<th>Lot Origin</th><th style="text-align:center;">New Lot</th><th>List Title</th>
								<th>Tags</th><th>Lot Estimated Cost</th><th>Notes</th>
							</tr></thead><tbody id="jo-detail-${count}"></tbody></table><br>`);

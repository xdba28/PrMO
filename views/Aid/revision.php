    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content animated fadeInUp">
										...
										<table class="table table-bordered table-hover <?php echo $animation;?>">
											...
											?>
												...
												<tr>
													...
													<td><?php echo $lotCount;?> - <?php echo $lot['l_title'];?></td>
				...
				<!-- denver! after this comment will be the second content or the step 2 after selecting the items to be resorted -->

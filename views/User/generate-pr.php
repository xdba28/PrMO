					...
					<div class="ibox-content">
						<table class="table table-bordered">
							...
							<tbody id="pr-tbl-${index}">
								<tr>
									<td><input type="text" name="pr-${index}-[stk][]" data-cnt="pr-${index}-lst-0" class="form-control"></td>
									<td class="center"><input type="text" name="pr-${index}-[unit][]" data-cnt="pr-${index}-lst-0" class="form-control"></td>
									<td><textarea rows="1" cols="30" name="pr-${index}-[desc][]" data-cnt="pr-${index}-lst-0" class="form-control" maxlength="1000"></textarea></td>
